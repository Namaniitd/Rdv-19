...
;(function(window) {
	...
	function MLSlideshow(el, options) {
		...
		// The slides
		this.slides = [].slice.call(this.el.querySelectorAll('.highlight-slide'));
		// Total slides.
	...
	MLSlideshow.prototype._init = function() {
		var self = this,
			onPreload = function() {
				self.el.classList.add('highlight-slideshow--loaded');
				// Set class current to the current slide.
				self.slides[self.current].classList.add('highlight-slide--current');
			};
	...
	MLSlideshow.prototype._navigate = function(direction) {
		...
		var self = this,
			...
			currentTitle = currentSlide.querySelector('.highlight-slide__title');
		...
		var nextSlide = this.slides[this.current],
			...
			nextTitle = nextSlide.querySelector('.highlight-slide__title');

		// Animate the nextSlide´s items in..
		var animateIn = function() {
			clearTimeout(self.navtime);

			var inItems = [].slice.call(nextSlide.querySelectorAll('.highlight-slide-imgwrap .highlight-slide__img-inner')),
			...
			nextSlide.classList.add('highlight-slide--current');
		...
		var outItems = [].slice.call(currentSlide.querySelectorAll('.highlight-slide-imgwrap .highlight-slide__img-inner')),
			...
			animeOutProps = {
				...
				complete: function() {
					currentSlide.classList.remove('highlight-slide--current');
				}
			};
