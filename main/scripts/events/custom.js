  ...
  var magic = [];
    ...
    function createEvents(eventList){
      ...
      for(var i=0;i<eventList.length;i++){
        var eventName = eventList[i].name;
        if(eventList.dtv){
          var date = eventList[i].dtv[0].date;
          var time = eventList[i].dtv[0].start_time;
          var venue = eventList[i].dtv[0].venue;
        }
        var date = "";
        var time = "";
    ...
    function createModal(eventList){
      ...
      for(var i=0;i<eventList.length;i++){
        ...
        var date = "";
        var time = "";
        var venue = "Contact Event Co-ordinator for all details";
                ...
                '<div class="modal-content">'+
                    ...
                    '<div class="modal-body">'+
                        '<main class="mainn">'+
                            ...
                            '<label for="tab3_'+eventName.split(' ').join('')+'" class="labelall">Eligibility</label>'+
