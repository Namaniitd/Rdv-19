    ...
    class Slideshow {
        ...
        createFrame() {
            ...
            <linearGradient id="gradient1" x1="0%" y1="0%" x2="0%" y2="100%">
                ...
                <stop offset="100%" stop-color="#d4d3a2"/>
            </linearGradient>
        ...
        navigate(dir = 'next') {
            ...
            anime({
                ...
                delay: (t, i, total) => dir === 'next' ? i * 0.0 : (total - i - 1) * 0.0,
                translateX: [0, dir === 'next' ? 100 : -100],
                opacity: [1, 0],
                complete: () => {
                ...
                return new Promise((resolve, reject) => {
                    ...
                    this.current = dir === 'next' ?
                        ...
                        anime({
                            ...
                            duration: this.settings.animation.slides.duration,
                            easing: this.settings.animation.slides.easing,
                            delay: (t, i, total) => dir === 'next' ? i * 100 + 1000 : (total - i - 1) * 100 + 1000,
                            translateX: [dir === 'next' ? -100 : 100, 0],
                            opacity: [0, 1]
                        });
                });
            };
            ...
            animateShapeIn.finished.then(currentTitleSlide).then(animateSlides).then(animateShapeOut);
        }
    };
